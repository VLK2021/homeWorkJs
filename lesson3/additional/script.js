...
// let altArray = [];
// let array = [25, 'hjhj', true, 548, 20,'idf', 56, false, 5236];
//  for (i = 0; i < array.length; i++) {
...
//             xxx = usersWithId[i];
//              xxx.addres = citiesWithId[j];
//         }
//     }
//    usersWithCities[i] = xxx;
// }
...
// ];
//
// document.write('<div class="wrap" style="display: flex; flex-wrap: wrap; align-items: flex-start; justify-content: space-between">');
// for (let i = 0; i < arrey.length; i++) {
//  let element = arrey[i];
//     document.write('<div class="post-card" style="width: 18%">');
//     document.write(`<h3> ${element["id"]} - ${element["title"]} </h3>`);
//     document.write(`<p style="text-align: justify"> ${element["body"]} </p>`);
//     document.write('</div>');
// }
// document.write('</div>');
...
//     }
// ];
// document.write('<div class="users-box" style="display: flex; flex-wrap: wrap; justify-content: space-evenly">');
// for (let i = 0; i < usersList.length; i++) {
//     const element = usersList[i];
//     console.log(element);
//     document.write('<div class="user-block" style="width: 48%; display: flex; flex-direction: column; margin-top: 20px">');
//     document.write(`<h2 style="margin: 0 0 20px 0"> ${element["id"]} - ${element["name"]} - ${element["username"]}  </h2>`);
//     document.write(`<h3 style="margin: 0 0 15px 0"> ${element["email"]} - ${element["phone"]}  </h3>`);
//     document.write('<div class="address-block">');
//     document.write(`<p style="margin: 0 0 10px 0"> ${element["address"]["city"]} - ADDRESS.CITY </p>`);
//     document.write(`<p style="margin: 0 0 10px 0"> ${element["address"]["street"]} - ADDRESS.STREET </p>`);
//     document.write(`<p style="margin: 0 0 10px 0"> ${element["address"]["suite"]} - ADDRESS.SUITE </p>`);
//     document.write(`<p style="margin: 0 0 10px 0"> ${element["address"]["zipcode"]} - ADDRESS.ZIPCODE </p>`);
//     document.write('</div>');
//     document.write('</div>');
// }
// document.write('</div>');
