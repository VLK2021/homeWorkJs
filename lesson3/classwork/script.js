...
// перебрати циклом while та вивести  числа тільки з непарним індексом в зворотньому циклі (с заду на перед)
...
//
//         if (key === 'photo') {
//              sims[key] = `<img src= ${sims[key]} alt="foto">`;
//         }
//
//         document.write(sims[key]);
//         document.write('<br/>' );
//     }
//
//     document.write('</div>');
...
//          }
//     }
//     document.write(`<h2> ${sims['name']} ${sims['surname']}. Age is - ${sims['age']} </h2>`);
//     document.write(`<p2> ${sims['info']} </p2>`);
//     document.write('<br/>' );
//
//     document.write(sims['photo']);
//
//     document.write('</div>');
// }
...
//
//         if (key === 'image') {
//             object[key] = `<img src= ${object[key]} alt="foto" width="200px">`;
//          }
//
//     }
//     document.write(`<h3 class="product-title"> ${object['title']}. Price - ${object['price']} </h3>`);
//     document.write(object['image']);
//
//     document.write('</div>');
// }
// document.write('</div>');
